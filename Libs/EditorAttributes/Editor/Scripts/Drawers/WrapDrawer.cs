    	...
    	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    	{
			...
			switch (property.propertyType)
			{
				...
				case SerializedPropertyType.Vector2Int:
					property.vector2IntValue = Vector3IntToVector2Int(WrapIntVector(minMaxX, minMaxY, minMaxZ, minMaxW, (Vector3Int)new Vector2Int(property.vector2IntValue.x, property.vector2IntValue.y)));
					break;
